...
│   ├── sep-02-federation.md   # Federation protocol
│   ├── sep-05-key-derivation.md # Mnemonic and key derivation
│   ├── sep-06-transfer.md     # Programmatic deposit/withdrawal
│   ├── sep-07-uri-scheme.md   # URI scheme for signing
│   ├── sep-08-regulated.md    # Regulated assets
│   ├── sep-10-auth.md         # Web authentication
│   ├── sep-11-txrep.md        # Transaction representation
│   ├── sep-12-kyc.md          # KYC API
│   ├── sep-24-interactive.md  # Interactive deposit/withdrawal
│   ├── sep-30-recovery.md     # Account recovery
│   ├── sep-31-cross-border.md # Cross-border payments
│   ├── sep-38-quotes.md       # Anchor quotes
│   └── sep-45-contract-auth.md # Contract account authentication
