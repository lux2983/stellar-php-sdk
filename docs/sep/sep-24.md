...
$personFields->bankAccountNumber = "123456789";
$personFields->bankRoutingNumber = "987654321";
...
| `pending_user_transfer_complete` | Stellar payment received, off-chain funds ready for pickup (withdrawals) |
...
| `on_hold` | Transaction on hold for additional checks (compliance review) |
...
try {
    ...
    // Re-authenticate with SEP-10 and retry
